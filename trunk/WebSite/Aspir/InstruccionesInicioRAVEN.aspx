<%@ Page Language="C#" MasterPageFile="Aspir.master" AutoEventWireup="true" CodeFile="InstruccionesInicioRAVEN.aspx.cs" Inherits="Aspir_Ini_Raven" Title="Psycho v1.2" %>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="550px">
                    ...
                    <tr>
                        ...
                        <br />                            
                            ...
                            &nbsp; &nbsp; &nbsp;
                            <asp:ImageButton ID="btnContinuar1" ImageUrl ="~/Aspir/Recursos/BtnContinuar.png" runat="server" OnClick="btnContinuarServerClick" />
                            <br />
                        </td>
                    </tr>
                </table>                            
                <asp:Label ID="lblRequired" runat="server" Font-Bold="True" Font-Names="Verdana"
                    Font-Size="Small" ForeColor="Red" Text="Debe ingresar el código del grupo" Visible="False"></asp:Label>
                <asp:Label ID="lblInvalid" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="Small"
                        ForeColor="Red" Text="Código no válido" Visible="False"></asp:Label>
            </td>
        </tr>    
    </table>              
    <br/>

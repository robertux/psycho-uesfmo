...
Public Class Evaluador
    ...
    Public Shared Function evaluarPruebaceps(ByVal a As Aspirante) As ResultadoCeps
        ...
        If totalc >= 12 And totalc <= 15 Then
        ...
        If totale >= 0 And totale <= 20 Then
        ...
        If totalp >= 0 And totalp <= 16 Then
        ...
        If totalsigno >= 0 And totalsigno <= 8 Then
            ...
            If totalsigno = 6 Then
                result.PDecision = 45
            End If
            If totalsigno = 7 Or totalsigno = 8 Then
                result.PDecision = 50
            End If
        End If
        If totalsigno > 8 Then
            ...
            If totalsigno = 13 Or totalsigno = 14 Then
                result.PDecision = 75
            End If
            If totalsigno > 14 And totalsigno <= 19 Then
                result.PDecision = 80
            End If
            If totalsigno > 19 And totalsigno <= 24 Then
                result.PDecision = 85
            End If
            If totalsigno > 24 And totalsigno <= 30 Then
                result.PDecision = 90
            End If
            If totalsigno > 30 And totalsigno <= 40 Then
                result.PDecision = 95
            End If
            If totalsigno > 40 And totalsigno <= 55 Then
                result.PDecision = 99
            End If

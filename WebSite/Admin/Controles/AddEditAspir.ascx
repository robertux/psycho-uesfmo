...
<table border="0" cellpadding="0" cellspacing="4"> 
    ...
    <tr>
        <td align="left" valign="top" style="width: 211px; height: 78px;"><font face="verdana" color="black" size="2"><b>Lugar de estudios</b></font></td><td align="left" style="width: 349px; height: 78px;"><font face="verdana" size="2">
            <asp:DropDownList ID="cmbdeptoestudios" runat="server" AutoPostBack="True" OnSelectedIndexChanged="cmbdeptoestudios_SelectedIndexChanged"
                Width="184px">
            </asp:DropDownList>
            <asp:DropDownList ID="cmbciudadestudios" runat="server" AutoPostBack="True" OnSelectedIndexChanged="cmbciudadestudios_SelectedIndexChanged"
                Width="184px">
            </asp:DropDownList>
            <br />

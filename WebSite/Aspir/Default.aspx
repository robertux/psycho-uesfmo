...
<%@ Register Src="Controles/copiaProgramacionPruebaR.ascx" TagName="copiaProgramacionPruebaR"
    TagPrefix="uc3" %>
<%@ Register Src="Controles/copiaProgramacionPruebaC.ascx" TagName="copiaProgramacionPruebaC"
    TagPrefix="uc4" %>
        ...
        <br/><div align="center">
            <table border="0" cellpadding="3" cellspacing="3">
                <tr>
                    ...
                    <td align="left" valign="top" style="width: 328px; height: 101px;">
                        <uc3:copiaProgramacionPruebaR ID="copiaProgramacionPruebaR" runat="server" />
                ...
                <tr>
                    ...
                    <td align="left" valign="top" style="width: 328px">
                        &nbsp; &nbsp;
                        <uc4:copiaProgramacionPruebaC ID="copiaProgramacionPruebaC" runat="server" />
                        <asp:Image ID="ImgEvaluadoC" runat="server" ImageUrl="~/Aspir/Recursos/BtnEvaluado.png"
                            Visible="False" /></td>
                </tr>
                <tr>
                    <td align="left" valign="top" style="width: 214px">
                        <font face="arial" color="black" size="3"><b>Resultado Final</b></font></td>

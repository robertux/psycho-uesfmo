...
<asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Italic="False" Font-Names="Arial"
    Text="Usuario:"></asp:Label>&nbsp;
<asp:Label ID="lblUser" runat="server" Font-Bold="False" Font-Italic="False" Font-Names="Arial"
